...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">婚纱预订列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="hunshayudingList2.do" name="myform" method="post">
									查询   订单号：<input name="dingdanhao" type="text" id="dingdanhao" class="form-control2" />  婚纱编号：<input name="hunshabianhao" type="text" id="hunshabianhao" class="form-control2" />  婚纱名称：<input name="hunshamingcheng" type="text" id="hunshamingcheng" class="form-control2" />  婚纱类型：<input name="hunshaleixing" type="text" id="hunshaleixing" class="form-control2" />
    ...
    <td align='center' bgcolor='#ebf0f7'>婚纱编号</td>
    <td align='center' bgcolor='#ebf0f7'>婚纱名称</td>
    <td align='center' bgcolor='#ebf0f7'>婚纱类型</td>
    ...
    <td height="45" align="center"> ${u.addtime } </td>
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateHunshayuding.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteHunshayuding.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="hunshayudingDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="hunshayudingList2.do?page=1" >首页</a>
             <a href="hunshayudingList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="hunshayudingList2.do?page=${page.page+1 }">下一页</a>
			<a href="hunshayudingList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
