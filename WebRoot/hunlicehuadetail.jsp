...
<jsp:include page="qttop.jsp"></jsp:include>
  ...
  <div class="family">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>策划方案：</td><td width='39%'>${hunlicehua.cehuafangan}</td><td  rowspan=4 align=center><a href=${hunlicehua.tupian} target=_blank><img src=${hunlicehua.tupian}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>价格：</td><td width='39%'>${hunlicehua.jiage}</td></tr><tr>         <td width='11%' height=44>联系电话：</td><td width='39%'>${hunlicehua.lianxidianhua}</td></tr><tr>         <td width='11%' height=44>地址：</td><td width='39%'>${hunlicehua.dizhi}</td></tr><tr>                           <td width='11%' height=100  >详细：</td><td width='39%' colspan=2 height=100 >${hunlicehua.xiangxi}</td></tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" /> <input type=button name=Submit53 value=婚礼策划预订 onClick="javascript:location.href='hunlicehuayudingadd.jsp?id=<%=request.getParameter("id")%>';"/> <!--jixaaxnnxiu--></td></tr>
