...
<jsp:include page="qttop.jsp"></jsp:include>
  ...
  <div class="family">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>婚纱编号：</td><td width='39%'>${hunshaxinxi.hunshabianhao}</td><td  rowspan=5 align=center><a href=${hunshaxinxi.tupian} target=_blank><img src=${hunshaxinxi.tupian}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>婚纱名称：</td><td width='39%'>${hunshaxinxi.hunshamingcheng}</td></tr><tr>         <td width='11%' height=44>婚纱类型：</td><td width='39%'>${hunshaxinxi.hunshaleixing}</td></tr><tr>                  <td width='11%' height=44>联系电话：</td><td width='39%'>${hunshaxinxi.lianxidianhua}</td></tr><tr>         <td width='11%' height=44>价格：</td><td width='39%'>${hunshaxinxi.jiage}</td></tr><tr>                  <td width='11%' height=100  >详细：</td><td width='39%' colspan=2 height=100 >${hunshaxinxi.xiangxi}</td></tr><tr>							 
	...
	pli=pli+1;
     %>
                                ...
                                </tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" /> <input type=button name=Submit53 value=婚纱预订 onClick="javascript:location.href='hunshayudingadd.jsp?id=<%=request.getParameter("id")%>';"/> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('hunshaxinxi','<%=id%>')"/></td></tr>
