...
<jsp:include page="qttop.jsp"></jsp:include>
  ...
  <div class="family">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>酒店编号：</td><td width='39%'>${hunjiudianyan.jiudianbianhao}</td><td  rowspan=5 align=center><a href=${hunjiudianyan.tupian} target=_blank><img src=${hunjiudianyan.tupian}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>酒店名称：</td><td width='39%'>${hunjiudianyan.jiudianmingcheng}</td></tr><tr>                  <td width='11%' height=44>星级：</td><td width='39%'>${hunjiudianyan.xingji}</td></tr><tr>         <td width='11%' height=44>联系电话：</td><td width='39%'>${hunjiudianyan.lianxidianhua}</td></tr><tr>         <td width='11%' height=44>地址：</td><td width='39%'>${hunjiudianyan.dizhi}</td></tr><tr>                  <td width='11%' height=100  >酒店简介：</td><td width='39%' colspan=2 height=100 >${hunjiudianyan.jiudianjianjie}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("hunjiudianyan",id)){
	pli=pli+1;
     %>
                                   <tr>
