...
<form action="hyjdList.do" name="myform" method="post" style="width:100%">
									...
									<input type="submit" value="查询" /> <input type="button" name="Submit2" value="切换视图"  onClick="javascript:location.href='hyjdListtp.do';" />
								</form>	
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.jiudianbianhao}</td>    <td>${u.jiudianmingcheng}</td>    <td width='90'><a href='${u.tupian}' target='_blank'><img src='${u.tupian}' width=88 height=99 border=0 /></a></td>    <td>${u.xingji}</td>    <td>${u.jiage}</td>    <td>${u.lianxidianhua}</td>    <td>${u.dizhi}</td>        
                              ...
                              <td align="center"><a href="hyjdDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="hyjdList.do?page=1" >首页</a>
             <a href="hyjdList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="hyjdList.do?page=${page.page+1 }">下一页</a>
			<a href="hyjdList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
