...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateHunyanjiudian.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改婚宴酒店<input type="hidden" name="id" value="${hunyanjiudian.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.jiudianbianhao.value='${hunyanjiudian.jiudianbianhao}';</script>	<script language="javascript">document.form1.jiudianmingcheng.value='${hunyanjiudian.jiudianmingcheng}';</script>	<script language="javascript">document.form1.tupian.value='${hunyanjiudian.tupian}';</script>	<script language="javascript">document.form1.xingji.value='${hunyanjiudian.xingji}';</script>	<script language="javascript">document.form1.jiage.value='${hunyanjiudian.jiage}';</script>	<script language="javascript">document.form1.lianxidianhua.value='${hunyanjiudian.lianxidianhua}';</script>	<script language="javascript">document.form1.dizhi.value='${hunyanjiudian.dizhi}';</script>	<script language="javascript">document.form1.jiudianjianjie.value='${hunyanjiudian.jiudianjianjie}';</script>	
					 </table>
			</form>
   </body>
</html>
