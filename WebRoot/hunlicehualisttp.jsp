...
<form action="hlchListtp.do" name="myform" method="post" style="width:100%">
									查询   策划方案：<input name="cehuafangan" type="text" id="cehuafangan" class="form-control2" />
									<input type="submit" value="查询" /> <input type="button" name="Submit2" value="切换视图"  onClick="javascript:location.href='hlchList.do';" />
								</form>	
<br />
...
<table width="100%" height="12%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				%>
                           <td height="316" align="center"><table width="225" height="285" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="250" align="center"><a href="hlchDetail.do?id=${u.id}"><img src="${u.tupian}" width="210" height="250" border="0" /></a></td>
                                </tr>
                                <tr>
                                  <td height="26" align="center">${u.cehuafangan}</td>
                                </tr>
                            </table></td>
							  <%
								if (i==4)
...
<p align="center"> <c:if test="${sessionScope.p==1}">
		 <c:if test="${page.page>1}">
              <a href="hlchListtp.do?page=1" >首页</a>
             <a href="hlchListtp.do?page=${page.page-1}"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="hlchListtp.do?page=${page.page+1}">下一页</a>
			<a href="hlchListtp.do?page=${page.totalPage}">末页</a>		    </c:if>		
	</c:if>
	</p>
