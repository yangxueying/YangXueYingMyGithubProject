...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">婚礼策划预订列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="hunlicehuayudingList.do" name="myform" method="post">
    ...
    <td align="center"> ${u.addtime } </td>
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateHunlicehuayuding.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteHunlicehuayuding.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="hunlicehuayudingList.do?page=1" >首页</a>
             <a href="hunlicehuayudingList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="hunlicehuayudingList.do?page=${page.page+1 }">下一页</a>
			<a href="hunlicehuayudingList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
